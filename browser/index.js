...
Define (String.prototype, "md", function () { return Function.hash.md (this); });
Define (String.prototype, "sha", function () { return Function.hash.sha (this); });
Define (String.prototype, "sha-x", function () { return Function.hash ["sha-x"] (this); });
...
Object.defineProperty (Function, "attribute", {value: function (dom, key, value) { return Function.attribute.set (key, value, Function.query.selector (dom)); }});
Object.defineProperty (Function.attribute, "get", {value: function (key, dom) { if (dom) return dom.getAttribute (key) || ""; }});
Object.defineProperty (Function.attribute, "set", {value: function (key, value, dom) { if (dom) return dom.setAttribute (key, value); }});
